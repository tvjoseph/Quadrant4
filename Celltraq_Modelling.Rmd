...
batTestSet <- batTestSet %>% select(Battery,Counter,Bench1,Bench2,featDischarge,conSlope,dodMin,Dod50,Dod85,Dodtop,conDrop,con50,con80,contop,voltSD)
...
2. Proceed with training with other methods like LDA, GLMNET etc
