...
4. After filtering the mean of the data is calculated. The mean value is the feature which is extracted for depth of discharge.
5. A check is done to verify if the dod has data in it. If there is no data within the date ranges, then the mean value of all the data sets for the battery is imputed.
